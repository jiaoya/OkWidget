    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        switch (action) {
            case MotionEvent.ACTION_POINTER_DOWN:
                LogUtil.d("weigan", "onInterceptTouchEvent ACTION_POINTER_DOWN");
            case MotionEvent.ACTION_DOWN:
                LogUtil.d("weigan", "onInterceptTouchEvent ACTION_DOWN");
                reset();
                break;
        }
        recyclerView = rv;
    ...
    private Runnable scrollRun = new Runnable() {
        ...
        public void run() {
            if (scroller != null && scroller.computeScrollOffset()) {
                LogUtil.d("weigan", "scrollRun called");
                scrollBy(scrollDistance);
                ViewCompat.postOnAnimation(recyclerView, scrollRun);
            }
        }
